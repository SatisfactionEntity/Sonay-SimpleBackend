...
<!-- END TAG -->
                ...
                <div class="form-group">
                    <input type="number" min="0" data-id="5" class="form-control" placeholder="Je hebt momenteel <?= Users::$Session->Data['5'] ?> Diamanten." value="">
                </div>
                <b>Hoeveel Duckets:</b>
                <div class="form-group">
                    <input type="number" min="0" data-id="0" class="form-control" placeholder="Je hebt momenteel <?= Users::$Session->Data['0'] ?> Duckets." value="">
                </div>
